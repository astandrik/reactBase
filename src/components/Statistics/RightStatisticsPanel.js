...
const constColors = ["#22B808", "#8A6CA7", "#EA2DA4", "#BDFA6D", "#4F4A22", "#70E9D1", "#F94D8D", "#D49160", "#35D40", "#A7F74A", "#D2257B", "#88FC24", "#48DA32", "#E46B3E", "#24D11C", "#AAD04F", "#A689ED", "#8B5F32", "#12797F", "#E65181", "#AC7711", "#F9CD57", "#85ECD2", "#67E77F", "#5BDEAA", "#E1573", "#B7B41F", "#19F04D", "#B725C8", "#A06933", "#F42DB3", "#3963A2", "#8DF8D2", "#642240", "#11759A", "#5B48E8", "#F5DB3F", "#6869B3", "#CD74D5", "#31CF2", "#978748", "#117D6A", "#FAAA1A", "#D96341", "#AD085C", "#3D0B42", "#545B47", "#64C4B9", "#CB840F", "#E451D8", "#F05AA8", "#B267A6", "#56F700", "#C5C32", "#C2B095", "#A18A2D", "#BB985B", "#A86E12", "#40C63C", "#DBA89D", "#959DFE", "#73029A", "#99DF9C", "#39C6E5", "#43CC7C", "#DFC540", "#25682E", "#984943", "#ACD4F", "#2D939", "#74DFD0", "#70DC9", "#805B49", "#5B602B", "#8710F8", "#E82FD3", "#DFA424", "#ACE6B6", "#D51EC3", "#4C0C2F", "#4D62A6", "#D7D798", "#7F4F37", "#51E3F2", "#756E88", "#9C224E", "#4B3510", "#63A79A", "#BD94B2", "#8FA208", "#90F99F", "#E07BA3", "#C6202D", "#385138", "#FD347E", "#A01CD8", "#75BADF", "#57EDB"];
      ...
      return (
        <Container vertical={true}>
          <div flex="1" className="reportHeaderContainer">
              <h4 className="reports-header"><span>{"Диаграма загрузки специалистов"}</span></h4>
          </div>
          <div flex="11">
            <Pie data={pieData}/>
          </div>
    ...
    <Container vertical={true}>
      <div flex="1" className="reportHeaderContainer">
        <RadioButtonGroup className={"period-type-choose-radio"} name="period_type" valueSelected={this.state.currentRadio}
          ...
          <h4 className="reports-header"><span>{"Гистограмма загрузки специалистов"}</span></h4>
      </div>
      <div flex="11">
        <Bar data={data}/>
      </div>

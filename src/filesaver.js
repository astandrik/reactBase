            ...
            if(R === 0) {
              if(colspan) {
                ...
                for(let i = 0; i < colspan;i++) {
                  wscols.push({wpx : cellValue==="Числа месяца" ? 50: 29})
                }
              } else {
                  wscols.push({wpx : 29})
              }
